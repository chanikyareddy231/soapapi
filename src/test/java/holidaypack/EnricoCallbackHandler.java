...
public abstract class EnricoCallbackHandler {
    ...
    public void receiveResultgetHolidaysForDateRange(
        holidaypack.EnricoStub.GetHolidaysForDateRangeResponse result) {
    }
    ...
    public void receiveResultisWorkDay(
        holidaypack.EnricoStub.IsWorkDayResponse result) {
    }
    ...
    public void receiveResultgetSupportedCountries(
        holidaypack.EnricoStub.GetSupportedCountriesResponse result) {
    }
    ...
    public void receiveResultisPublicHoliday(
        holidaypack.EnricoStub.IsPublicHolidayResponse result) {
    }
    ...
    public void receiveResultwhereIsPublicHoliday(
        holidaypack.EnricoStub.WhereIsPublicHolidayResponse result) {
    }
    ...
    public void receiveResultgetHolidaysForYear(
        holidaypack.EnricoStub.GetHolidaysForYearResponse result) {
    }
    ...
    public void receiveResultgetHolidaysForMonth(
        holidaypack.EnricoStub.GetHolidaysForMonthResponse result) {
    }
